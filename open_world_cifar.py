...
class OPENWORLDCIFAR100(torchvision.datasets.CIFAR100):
    ...
    def __init__(self, root, labeled=True, train_classes=[], labeled_ratio=0.5, rand_number=0, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            if labeled:
                self.labeled_idxs, self.unlabeled_idxs = self.get_labeled_index(train_classes, labeled_ratio)
